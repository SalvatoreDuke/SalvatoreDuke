...
- 🔧 Trabalho principalmente com **C/C++** e **Python**
- 🎮 Participo de um projeto de extensão universitária de **desenvolvimento de jogos** (C#, Unity, Godot)
- 🐧 Desenvolvo em ambiente **Linux**
- 📚 Estudando atualmente: engenharia de software, banco de dados e recuperação da informação
